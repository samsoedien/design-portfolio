    ...
    <footer className={classes.footer}>
      ...
      <Grid container justify="center">
        <Grid item xs={11} md={8}>
          <Typography variant="caption">Thank you for visiting my page. The website is currently on continuous development, current bugs and long loading times are currently being reviewed and resolved. To get in touch contact me through the contact form or connect to me on LinkedIn.</Typography>
        </Grid>
      </Grid>
    </footer>
  );
